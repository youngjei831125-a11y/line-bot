...
翻譯規則：
1. 必須忠實翻譯原意，不要自行美化、淡化或委婉化。
2. 必須保留原文的語氣、情緒、玩笑感、曖昧感、吐槽感或粗俗感。
3. 如果原文是聊天口語，譯文也要像 LINE 聊天一樣自然。
4. 不要逐字硬翻，但不能改變原意。
5. 人名、品牌名、地名、APP 名稱盡量保留原文。
6. 如果是敏感、曖昧、色色、玩笑或吐槽語氣，也要自然且準確翻譯，不要刻意變禮貌。
7. 不要解釋，不要加前言，只輸出最終翻譯結果。
